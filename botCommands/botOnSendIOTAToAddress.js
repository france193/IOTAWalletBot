...
e.botOnSendIOTAToAddress = botOnSendIOTAToAddress;
e.botOnSendIOTAToAddressAfterReceivingData = botOnSendIOTAToAddressAfterReceivingData;
...
async function botOnSendIOTAToAddress(msg) {
	...
	try {
		if (Utils.isIDAuthorized(id) || PUBLIC_BOT) {
			...
			Utils.checkUserStatusBeforePermittingActions(id, functionName, "SEND_TRANSFER_TO_ADDRESS");
		} else {
